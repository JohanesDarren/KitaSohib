...
const Developers: React.FC = () => {
  return (
    <section id="developers" className="py-24 px-4 md:px-8 bg-slate-50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {developers.map((dev, index) => (
            <motion.div
              ...
              className="bg-white p-8 rounded-3xl shadow-soft hover:shadow-glow transition-all duration-300 text-center group"
            >
              <div className="relative w-40 h-40 mx-auto mb-6 rounded-full overflow-hidden border-4 border-primary-50 group-hover:border-primary-100 transition-colors">
                <img
                  src={dev.image}
                  alt={dev.name}
